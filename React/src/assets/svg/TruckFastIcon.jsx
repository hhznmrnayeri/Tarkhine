...
export default function TruckFastIcon({ size }) {
  return (
    <svg
      className={`${size}`}
    ...
    >
      <path
        fill="currentColor"
        d="M13 15.25h-1c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h1c.69 0 1.25-.56 1.25-1.25V3.25H6c-1.18 0-2.26.64-2.84 1.67-.2.36-.66.49-1.02.29a.753.753 0 01-.29-1.02C2.69 2.69 4.28 1.75 6 1.75h9c.41 0 .75.34.75.75v10c0 1.52-1.23 2.75-2.75 2.75z"
      ></path>
      <path
        fill="currentColor"
      ...
      <path
        fill="currentColor"
        d="M8 23.25c-1.52 0-2.75-1.23-2.75-2.75S6.48 17.75 8 17.75s2.75 1.23 2.75 2.75S9.52 23.25 8 23.25zm0-4a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5zM16 23.25c-1.52 0-2.75-1.23-2.75-2.75s1.23-2.75 2.75-2.75 2.75 1.23 2.75 2.75-1.23 2.75-2.75 2.75zm0-4a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5zM22 15.25h-3c-.96 0-1.75-.79-1.75-1.75v-3c0-.96.79-1.75 1.75-1.75h1.29c.27 0 .52.14.65.38l1.71 3c.06.11.1.24.1.37v2c0 .41-.34.75-.75.75zm-3-5c-.14 0-.25.11-.25.25v3c0 .14.11.25.25.25h2.25V12.7l-1.4-2.45H19zM8 9.25H2c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h6c.41 0 .75.34.75.75s-.34.75-.75.75zM6 12.25H2c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h4c.41 0 .75.34.75.75s-.34.75-.75.75zM4 15.25H2c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h2c.41 0 .75.34.75.75s-.34.75-.75.75z"
      ></path>
    </svg>
  );
}
