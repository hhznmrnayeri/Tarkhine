...
<div className="flex flex-col rounded md:rounded-lg border overflow-hidden border-gray-400">
    {/* result img */}
    <img src={props.img} alt="food" className="food__img object-cover w-full h-60 md:h-72"/>
    {/* result content */}
    <div className="bg-white p-4 flex-center flex-col gap-4">
            {/* result name */}
            <h2 className="food__name text-xs md:text-xl font-estedadSemiBold">{props.title}</h2>
