            ...
            <div className="flex flex-col gap-7 md:gap-6 mt-6 md:mt-12">
                ...
                <div className=" flex items-center flex-col md:flex-row justify-between gap-2 md:h-72 border border-gray-400 rounded md:rounded-lg group relative overflow-hidden">
                    ...
                    <div className="md:flex md:flex-center md:bg-black/40 w-full md:w-6/12 h-full  md:rounded-lg absolute md:inset-0 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
                        {/* gallery icon */}
                        <button onClick={openGalleryModal} className="gallery__icon text-white">
                    ...
                    {/* branch img */}
                    <img src="src/assets/images/home/branch.webp" alt="branch" className="  w-full md:w-6/12 h-28 md:h-full object-cover "/>
                    {/* branch content */}
                    <div className="flex flex-col items-center gap-1 px-3 md:-translate-y-2 md:group-hover:-translate-y-10 pb-4 transition-all duration-300 bg-white z-10 text-center md:flex-1 w-full">
                        {/* brach title */}
                        <h4 className="text-xs md:text-xl md:font-estedadSemiBold">شعبه اکباتان</h4>
                        {/* branch address */}
                        <p className="text-gray-700 text-2xs md:text-lg mt-1 md:mt-2">آدرس: شهرک اکباتان، فاز ۳، مجتمع تجاری کوروش، طبقه سوم</p>
                        {/* branch phone */}
                        <p className="text-gray-700 text-2xs md:text-lg">شماره تماس: <span dir="ltr">۰۲۱-۵۴۸۹۱۲۵۰-۵۱</span></p>
                        {/* branch time */}
                        <p className="text-gray-700 text-2xs md:text-lg">ساعت کاری: همه‌روزه از ساعت ۱۲ تا ۲۳ بجز روز‌های تعطیل</p>
                        {/* btn wrapper */}
                        <div className="flex-center gap-4 md:gap-5 mt-3 text-2xs md:text-base md:font-estedadMedium md:absolute md:h-10 w-full md:left-0 md:right-0 md:mx-auto md:-bottom-10 md:group-hover:-bottom-10 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
                            {/* branch btn */}
                            <button className="branch__btn text-primary bg-white border border-primary rounded h-6 md:h-10 w-full md:w-32">صفحه شعبه</button>
                            {/* map btn */}
                            <button className="bg-primary text-white rounded h-6 md:h-10 w-full md:w-32">دیدن در نقشه</button>
                        </div>
                    </div>
                </div>
                {/* branch item */}
                <div className=" flex items-center flex-col md:flex-row justify-between gap-2 md:h-72 border border-gray-400 rounded md:rounded-lg group relative overflow-hidden">
                    ...
                    {/* branch img */}
                    <img src="src/assets/images/home/branch1.webp" alt="branch" className="  w-full md:w-6/12 h-28 md:h-full object-cover "/>
                    {/* branch content */}
                    <div className="flex flex-col items-center gap-1 px-3 md:-translate-y-2 md:group-hover:-translate-y-10 pb-4 transition-all duration-300 bg-white z-10 text-center md:flex-1 w-full">
                        {/* brach title */}
                        <h4 className="text-xs md:text-xl md:font-estedadSemiBold">شعبه چالوس</h4>
                        {/* branch address */}
                        <p className="text-gray-700 text-2xs md:text-lg mt-1 md:mt-2">چالوس، خیابان ۱۷ شهریور، بعد کوچه کوروش، جنب داروخانه دکتر میلانی</p>
                        {/* branch phone */}
                        <p className="text-gray-700 text-2xs md:text-lg">شماره تماس: <span dir="ltr">۰۲۱-۵۴۸۹۱۲۵۰-۵۱</span></p>
                        {/* branch time */}
                        <p className="text-gray-700 text-2xs md:text-lg">ساعت کاری: همه‌روزه از ساعت ۱۲ تا ۲۳ بجز روز‌های تعطیل</p>
                ...
                <div className=" flex items-center flex-col md:flex-row justify-between gap-2 md:h-72 border border-gray-400 rounded md:rounded-lg group relative overflow-hidden">
                    ...
                    {/* branch img */}
                    <img src="src/assets/images/home/branch2.webp" alt="branch" className="  w-full md:w-6/12 h-28 md:h-full object-cover "/>
                    {/* branch content */}
                    <div className="flex flex-col items-center gap-1 px-3 md:-translate-y-2 md:group-hover:-translate-y-10 pb-4 transition-all duration-300 bg-white z-10 text-center md:flex-1 w-full">
                        {/* brach title */}
                        <h4 className="text-xs md:text-xl md:font-estedadSemiBold">شعبه چالوس</h4>
                        {/* branch address */}
                        <p className="text-gray-700 text-2xs md:text-lg mt-1 md:mt-2">خیابان اقدسیه ، نرسیده به میدان خیام، پلاک ۸</p>
                        {/* branch phone */}
                        <p className="text-gray-700 text-2xs md:text-lg">شماره تماس: <span dir="ltr">۰۲۱-۵۴۸۹۱۲۵۴-۵۵</span></p>
                        {/* branch time */}
                        <p className="text-gray-700 text-2xs md:text-lg">ساعت کاری: همه‌روزه از ساعت ۱۲ تا ۲۳ بجز روز‌های تعطیل</p>
                        {/* btn wrapper */}
                        <div className="flex-center gap-4 md:gap-5 mt-3 text-2xs md:text-base md:font-estedadMedium md:absolute md:h-10 w-full md:left-0 md:right-0 md:mx-auto md:-bottom-10 md:group-hover:-bottom-10 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
                ...
                <div className=" flex items-center flex-col md:flex-row justify-between gap-2 md:h-72 border border-gray-400 rounded md:rounded-lg group relative overflow-hidden">
                    ...
                    {/* branch img */}
                    <img src="src/assets/images/home/branch3.webp" alt="branch" className="  w-full md:w-6/12 h-28 md:h-full object-cover "/>
                    {/* branch content */}
                    <div className="flex flex-col items-center gap-1 px-3 md:-translate-y-2 md:group-hover:-translate-y-10 pb-4 transition-all duration-300 bg-white z-10 text-center md:flex-1 w-full">
                        {/* brach title */}
                        <h4 className="text-xs md:text-xl md:font-estedadSemiBold">شعبه ونک</h4>
                        {/* branch address */}
                        <p className="text-gray-700 text-2xs md:text-lg mt-1 md:mt-2">میدان ونک، خیابان فردوسی، نبش کوچه نیلوفر، پلاک ۲۶</p>
                        {/* branch phone */}
                        <p className="text-gray-700 text-2xs md:text-lg">شماره تماس: <span dir="ltr">۰۲۱-۵۴۸۹۱۲۵۶-۵۷</span></p>
                        {/* branch time */}
                        <p className="text-gray-700 text-2xs md:text-lg">ساعت کاری: همه‌روزه از ساعت ۱۲ تا ۲۳ بجز روز‌های تعطیل</p>
                        {/* btn wrapper */}
                        <div className="flex-center gap-4 md:gap-5 mt-3 text-2xs md:text-base md:font-estedadMedium md:absolute md:h-10 w-full md:left-0 md:right-0 md:mx-auto md:-bottom-10 md:group-hover:-bottom-10 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
