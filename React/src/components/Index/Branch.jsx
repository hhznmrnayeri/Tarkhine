    ...
    <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-6 mt-3 md:mt-6">
            ...
            <div className="col-span-1 md:col-span-3 flex md:flex-col items-start md:items-center gap-2  border border-primary md:border-gray-400 rounded md:rounded-lg group relative overflow-hidden">
                ...
                {/* branch img */}
                <img src="src/assets/images/home/branch.webp" alt="branch" className="w-36 md:w-full object-cover"/>
                {/* branch content */}
                <div className="flex flex-col items-center gap-1 px-3 md:-translate-y-2 md:group-hover:-translate-y-10 pb-4 pt-2 transition-all duration-300 w-full bg-white z-10 text-center">
                    {/* brach title */}
                    <h4 className="text-sm md:text-lg lg:text-2xl  font-estedadMedium md:font-estedadSemiBold">شعبه اکباتان</h4>
                    {/* branch caption */}
                    <p className=" text-2xs text-gray-700 md:text-sm md:font-estedadMedium md:h-20 lg:h-16 xl:h-10">شهرک اکباتان، فاز ۳، مجتمع تجاری کوروش، طبقه سوم</p>
                    {/* branch btn */}
                    <NavLink to='/branch' className="flex-center gap-1 md:text-primary text-xs md:p-2 md:rounded md:border md:border-primary absolute md:h-8 md:w-32 md:left-0 md:right-0 md:mx-auto md:-bottom-8 md:group-hover:-bottom-8 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
            ...
            <div className="col-span-1 md:col-span-3 flex md:flex-col items-start md:items-center gap-2  border border-primary md:border-gray-400 rounded md:rounded-lg group relative overflow-hidden">
                ...
                {/* branch img */}
                <img src="src/assets/images/home/branch1.webp" alt="branch" className="w-36 md:w-full object-cover"/>
                {/* branch content */}
                <div className="flex flex-col items-center gap-1 px-3 md:-translate-y-2 md:group-hover:-translate-y-10 pb-4 pt-2 transition-all duration-300 w-full bg-white z-10 text-center">
                    {/* brach title */}
                    <h4 className="text-sm md:text-lg lg:text-2xl  font-estedadMedium md:font-estedadSemiBold">شعبه چالوس</h4>
                    {/* branch caption */}
                    <p className=" text-2xs text-gray-700 md:text-sm md:font-estedadMedium md:h-20 lg:h-16 xl:h-10">چالوس، خیابان ۱۷ شهریور، بعد کوچه کوروش، جنب داروخانه دکتر میلانی</p>
                    {/* branch btn */}
                    <NavLink to='/branch' className="flex-center gap-1 md:text-primary text-xs md:p-2 md:rounded md:border md:border-primary absolute md:h-8 md:w-32 md:left-0 md:right-0 md:mx-auto md:-bottom-8 md:group-hover:-bottom-8 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
                        <span className="hidden md:block">صفحه شعبه</span>
                        <GoChevronLeft className="w-4 h-4 hidden md:block"/>
            ...
            <div className="col-span-1 md:col-span-3 flex md:flex-col items-start md:items-center gap-2  border border-primary md:border-gray-400 rounded md:rounded-lg group relative overflow-hidden">
                ...
                {/* branch img */}
                <img src="src/assets/images/home/branch2.webp" alt="branch" className="w-36 md:w-full object-cover"/>
                {/* branch content */}
                <div className="flex flex-col items-center gap-1 px-3 md:-translate-y-2 md:group-hover:-translate-y-10 pb-4 pt-2 transition-all duration-300 w-full bg-white z-10 text-center">
                    {/* brach title */}
                    <h4 className="text-sm md:text-lg lg:text-2xl  font-estedadMedium md:font-estedadSemiBold">شعبه اقدسیه</h4>
                    {/* branch caption */}
                    <p className="text-2xs text-gray-700 md:text-sm md:font-estedadMedium md:h-20 lg:h-16 xl:h-10">خیابان اقدسیه ، نرسیده به میدان خیام، پلاک ۸</p>
                    {/* branch btn */}
                    <NavLink to='/branch' className="flex-center gap-1 md:text-primary text-xs md:p-2 md:rounded md:border md:border-primary absolute md:h-8 md:w-32 md:left-0 md:right-0 md:mx-auto md:-bottom-8 md:group-hover:-bottom-8 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
                        <span className="hidden md:block">صفحه شعبه</span>
                        <GoChevronLeft className="w-4 h-4 hidden md:block"/>
            ...
            <div className="col-span-1 md:col-span-3 flex md:flex-col items-start md:items-center gap-2  border border-primary md:border-gray-400 rounded md:rounded-lg group relative overflow-hidden">
                ...
                {/* branch img */}
                <img src="src/assets/images/home/branch3.webp" alt="branch" className="w-36 md:w-full object-cover"/>
                {/* branch content */}
                <div className="flex flex-col items-center gap-1 px-3 md:-translate-y-2 md:group-hover:-translate-y-10 pb-4 pt-2 transition-all duration-300 w-full bg-white z-10 text-center">
                    {/* brach title */}
                    <h4 className="text-sm md:text-lg lg:text-2xl  font-estedadMedium md:font-estedadSemiBold">شعبه ونک</h4>
                    {/* branch caption */}
                    <p className="text-2xs text-gray-700 md:text-sm md:font-estedadMedium md:h-20 lg:h-16 xl:h-10">میدان ونک، خیابان فردوسی، نبش کوچه نیلوفر، پلاک ۲۶</p>
                    {/* branch btn */}
                    <NavLink to='/branch' className="flex-center gap-1 md:text-primary text-xs md:p-2 md:rounded md:border md:border-primary absolute md:h-8 md:w-32 md:left-0 md:right-0 md:mx-auto md:-bottom-8 md:group-hover:-bottom-8 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
                        <span className="hidden md:block">صفحه شعبه</span>
                        <GoChevronLeft className="w-4 h-4 hidden md:block"/>
