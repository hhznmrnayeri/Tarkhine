...
<div className="col-span-6 md:col-span-12 lg:col-span-6 xl:col-span-4 flex flex-col overflow-hidden rounded md:rounded-lg border border-gray-400">
    {/* img */}
    <img src={props.img} alt="food" className="w-full rounded md:rounded-lg"/>
    {/* favorite content */}
    <div className="p-2 md:p-4">
        {/* top wrapper */}
        <div className="flex items-center justify-between">
            {/* favorite title */}
            <h4 className="text-xs md:text-xl md:font-estedadSemiBold">{props.name}</h4>
            {/* heart btn */}
        ...
        {/* btn */}
        <button className="text-2xs text-white bg-primary md:font-estedadMedium md:text-base rounded p-2 md:px-4 w-full h-10 mt-2 md:mt-6">افزودن به سبد خرید</button>
    </div>
</div>
)
}