...
<div className="bg-gray-300">
    <div className="container">
        <div className="py-1.5 md:pt-4 flex items-center gap-4 md:gap-8 text-gray-700 text-xs md:text-xl">
            ...
            <NavLink to='/question/privacy' className="state__question--active">حریم خصوصی</NavLink>
        </div>
    </div>
</div>
<div className="container mb-6 md:mb-12">
    <div className='transition-all duration-300 mt-3 md:mt-6 visible opacity-100 h-auto border border-gray-400 rounded overflow-hidden'>
        ...
        <Accordion id='3' question='چگونه اطلاعات شما را گردآوری می‌کنیم؟' answer='از شما تقاضا خواهیم کرد اطلاعات خود را در اختیار ما قرار دهید؛ هنگامی‌که:
                            &#10
        ...
        <Accordion id='4' question='چرا به شماره تلفن شما نیاز داریم؟' answer='برای ثبت نام در وب‌سایت ترخینه باید نخست شماره موبایل خود را وارد کنید تا کد فعال‌سازی برای شما ارسال شود.
        ...
        <Accordion id='5' question='فعالیت‌های مرورگر شما در هنگام بازدید از وب‌سایت ترخینه' answer={`هنگامی‌که شما از وب‌سایت ترخینه استفاده می‌کنید، ما اطلاعاتی درباره‌ی فعالیت‌های شما گردآوری می‌کنیم که برخی از این اطلاعات عبارتند از:
                            &#10
