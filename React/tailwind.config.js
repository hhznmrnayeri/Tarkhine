  ...
  theme: {
    extend: {
      ...
      backgroundImage:{
        ...
        // "header-representation":"linear-gradient(0deg, rgba(0, 0, 0, 0.55) 0%, rgba(0, 0, 0, 0.55) 100%), linear-gradient(0deg, rgba(33, 64, 43, 0.50) 0%, rgba(33, 64, 43, 0.50) 100%), url(assets/images/representation/header.jpg)",
      },
      fontFamily:{
        "estedad":"Estedad",
